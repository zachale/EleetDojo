...
class _learningFromSenseiScreen extends State<learningFromSenseiScreen> {
  ...
  Future<void> getSensei(String userQuestion, String correctAnswer, String userChoice, String ogQuestion) async {
    ...
    {
      contextText = "Your are a chatbot called Sensei that helps users understand why their quiz answer was wrong. Your will be given the Problem question, the correct answer and the users answer. It is your job to help the user understand why they got the answer wrong. The follwing is the context. Problem Question: $ogQuestion. The correct answer is: $correctAnswer. The user selected: $userChoice.";
    }
